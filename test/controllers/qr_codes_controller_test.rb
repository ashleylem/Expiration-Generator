...
class QrCodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create qr_code" do
    assert_difference("QrCode.count") do
      post qr_codes_url, params: { qr_code: { code: @qr_code.code, user_id: @qr_code.user_id } }
    end
  ...
  test "should update qr_code" do
    patch qr_code_url(@qr_code), params: { qr_code: { code: @qr_code.code, user_id: @qr_code.user_id } }
